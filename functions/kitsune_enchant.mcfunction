...
kill @e[type=item,nbt={OnGround:1b},nbt={Item:{id:"minecraft:paper"}},limit=1,sort=nearest,distance=..1.425,nbt={Item:{tag:{display:{Lore:['{"text":"Extinguish","color":"gray","italic":false}']}}}}]
