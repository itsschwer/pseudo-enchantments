...
1. Download:
    - [Repository as a `.zip`](https://github.com/itsschwer/extinguish/archive/refs/heads/master.zip) *(Code > Download ZIP)*
    - [Release](https://github.com/itsschwer/extinguish/releases) *(will need to unzip before installing into a save)*
